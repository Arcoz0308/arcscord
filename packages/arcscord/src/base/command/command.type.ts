...
export type CommandProps<
  Definer extends SubCommandDefinition | FullCommandDefinition = SubCommandDefinition | FullCommandDefinition,
  Middlewares extends CommandMiddleware[] = CommandMiddleware[]
> = {
  build: Definer;
  options?: CommandOptions;
  run: (ctx: CommandContext<Definer, Middlewares>) => MaybePromise<CommandRunResult>;
  use?: Middlewares;
